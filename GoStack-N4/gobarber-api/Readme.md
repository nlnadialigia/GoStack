...
Nesse módulo foi ensinado os princípios da programação, arquitetura de software dentro do back-end que vai fazer a aplicação ser escalável, assim como testes automatizados e a metodologia TDD (Test-Driven Development).
